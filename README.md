...
```bash
npm install silentium-jsdom
```
This library is designed to bring JsDOM to interfaces compatible with the Silentium library. The main goal of creating this library was testing, but it may also be useful for Server Side Rendering.
